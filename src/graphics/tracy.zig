...
const ___tracy_gpu_context_name_data = extern struct {
    context: u8,
    name: [*:0]const u8,
    len: u16,
};
...
extern fn ___tracy_emit_gpu_zone_begin(data: ___tracy_gpu_zone_begin_data) void;
extern fn ___tracy_emit_gpu_zone_end(data: ___tracy_gpu_zone_end_data) void;
